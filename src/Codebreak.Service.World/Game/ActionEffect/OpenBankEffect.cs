...
namespace Codebreak.Service.World.Game.ActionEffect
{
    ...
    public sealed class OpenBankEffect : ActionEffectBase<OpenBankEffect>
    {
        ...
        /// <returns></returns>
        public override bool ProcessItem(CharacterEntity character, Database.Structure.InventoryItemDAO item, Stats.GenericEffect effect, long targetId, int targetCell)
        {
