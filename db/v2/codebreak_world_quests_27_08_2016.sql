...
INSERT INTO `characterquest` (`Id`, `Done`, `CurrentStepId`, `SerializedObjectives`) VALUES
	(11074, b'1', 951, '3537:1');
...
-- Export de données de la table codebreak_world.questobjective: ~0 rows (environ)
...
-- Export de données de la table codebreak_world.queststep: ~0 rows (environ)
